from acsa_gcae_g.preproc import prepro
from acsa_gcae_g.acsa_gcae_g import ACSA_GCAE_G
from acsa_gcae_g.basic import get_score
from acsa_gcae_g.dataset import get_loader
from acsa_gcae_g.config import config
import torch
...
def train(config):
    ...
    # init model
    model = ACSA_GCAE_G(dim_word=config.dim_word, num_kernel=config.num_kernel, num_classification=config.num_class,
                        kernel_sizes=config.kernel_sizes, maxlen=config.sent_limit, dropout_rate=config.dropout_rate,
