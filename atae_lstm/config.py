...
flags.DEFINE_string('model', 'atae_lstm', 'atae lstm model')
# data input files
...
flags.DEFINE_string('result_save', 'result', 'save experiment results')
...
flags.DEFINE_integer('dim_hidden', 300, 'hidden state dimension of lstm')
