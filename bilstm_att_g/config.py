...
flags.DEFINE_string('model', 'bilstm_att_g', 'bilstm attention with gate model')
# data input files
...
flags.DEFINE_integer('dim_hidden', 150, 'hidden state dimension of lstm')
flags.DEFINE_integer('dim_att_hidden', 100, 'dimention of attention hidden')
