...
flags.DEFINE_string('model', 'gcm', 'gcm model')
# data input files
...
flags.DEFINE_integer('num_channel', 200, 'number of convolution output channel')
flags.DEFINE_integer('kernel_size', 3, 'convolution kernel size')
flags.DEFINE_integer('aspect_kernel_size', 3, 'aspect convolution kernel size')
flags.DEFINE_integer('num_layer', 4, 'number of layers')
