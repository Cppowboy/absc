from hair.preproc import prepro
from hair.hair import Hair
from hair.basic import get_score
from hair.dataset import get_loader
from hair.config import config
import torch
...
def train(config):
    ...
    for epoch in tqdm(range(config.max_epoch)):
        ...
        torch.save(model.state_dict(), os.path.join(
            model_save_dir, '{}.pth'.format(epoch)))
