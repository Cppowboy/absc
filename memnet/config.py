...
flags.DEFINE_string('model', 'memnet', 'memnet model')
# data input files
...
flags.DEFINE_integer('kernel_size', 3, 'kernel size of convolution feature extractor')
flags.DEFINE_integer('conv_channel', 200, 'convolution feature extractor, output channel')
flags.DEFINE_integer('cpt_num', 2, 'number of cpt layer')
