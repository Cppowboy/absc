...
flags.DEFINE_string('model', 'model', 'my own model')
# data input files
...
flags.DEFINE_integer('max_epoch', 30, 'max train epoch')
...
flags.DEFINE_integer('num_channel', 200, '')
flags.DEFINE_integer('dim_hidden', 200, '')
